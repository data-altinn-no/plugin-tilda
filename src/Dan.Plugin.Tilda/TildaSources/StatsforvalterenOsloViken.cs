...
{
    public class StatsforvalterenOsloViken : TildaDataSource, ITildaAuditCoordination, ITildaAuditCoordinationAll, ITildaAuditReports
    {
        ...
        public StatsforvalterenOsloViken(IOptions<Settings> settings,
